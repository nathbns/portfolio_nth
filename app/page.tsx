      ...
      <section className="flex flex-col items-center justify-center">
        <div className="w-full max-w-4xl">
          <p className="text-sm sm:text-base md:text-lg leading-relaxed">
            Currently studying at <a href="https://polytech.univ-lyon1.fr/formation/cycle-ingenieur/informatique/informatique-par-cursus-classique" target="_blank" className="text-foreground/80">
            <span className="underline">Polytechnique Lyon.</span></a>
            <br />
            <br />
            <span style={{ color: "#7aa2f7" }}>def</span> <span style={{ color: "#bb9af7" }}>little_bit_about_me</span><span style={{ color: "#c0caf5" }}>(</span><span style={{ color: "#9ece6a" }}>self</span><span style={{ color: "#c0caf5" }}>)</span><span style={{ color: "#c0caf5" }}>:</span> 
            ...
            <br />
            <br />
            <span style={{ color: "#7aa2f7" }}>def</span> <span style={{ color: "#bb9af7" }}>outside_of_class_i_do_projects</span><span style={{ color: "#c0caf5" }}>(</span><span style={{ color: "#9ece6a" }}>self</span><span style={{ color: "#c0caf5" }}>)</span><span style={{ color: "#c0caf5" }}>:</span>
            <br />
            <br />
